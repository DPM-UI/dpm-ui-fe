    ...
    return (
        <div className="bg-gradient-to-br from-[#2C8EBF] to-green-1 w-full rounded-2xl h-full py-8 ">
            ...
            <Header preset="h4" className="mx-36 text-center text-white mt-2">
                ...
                dalam IKM UI yang memiliki kekuasaan legislatif. Mengusung semangat "Memaknai Keberagaman UI", DPM UI
                2022 berusaha memberikan warna bagi seluruh civitas akademik Universitas Indonesia.
            </Header>
        </div>
    );
};
